...
function M.setup()
  ...
  -- Diagnostics (all open buffers) in the quickfix list rather than the location
  -- list, so they share one window with grr's references instead of stacking.
  -- Switch between the two lists with < and > (bqf) inside the quickfix window.
